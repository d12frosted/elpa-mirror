...
;; Package-Version: 20210921.1400
;; Package-Commit: 2458b3c9f4e59646f6a83bd51860d28507e746cd
...
(defun spell-fu--idle-timer-enable ()
  ...
  (unless spell-fu--idle-timer
    (setq spell-fu--idle-timer
      (run-with-idle-timer
        spell-fu-idle-delay t #'spell-fu--idle-handle-pending-ranges-or-disable))))
...
(defun spell-fu--idle-timer-reset-on-state-change ()
  ...
  (if (bound-and-true-p spell-fu-mode)
