...
;; Package-Version: 20221227.1244
;; Package-Commit: c17add8b63bb71eb45f9b07c73430a4464395c6e
...
(defun bookmark-in-project--step-any (pi-list direction)
  ...
  (let ((keep-searching t)
    ...
    (while (and keep-searching (< skip pi-list-length))
      (let ((pi (bookmark-in-project--step-any-impl pi-list direction filepath-current pos-current)))
        (cond
         (pi
