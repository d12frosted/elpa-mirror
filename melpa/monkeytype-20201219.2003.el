...
;; Version: 0.1.3
;; Package-Version: 20201219.2003
;; Package-Commit: 96987fcd75dcac1a55518ae10c720f3ed8c9614f
;; Keywords: games
...
(defun monkeytype--utils-check-for-pandoc ()
  ...
  (if (executable-find "pandocxxetx")
      t
...
further character encoding to ASCII (using iconv(1))."
  ...
  (let* ((path (concat monkeytype-directory "text/" file-name))
         ...
         (text-opts " -t plain")
         (asciify (if (monkeytype--check-for-iconv)
                      (format
