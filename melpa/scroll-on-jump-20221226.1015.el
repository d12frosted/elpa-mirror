...
;; Package-Version: 20221226.1015
;; Package-Commit: 0c4fc1b64366cbc60f0d4c6c5c6c1aea5294fd79
;; Version: 0.1
...
without changing behavior anywhere else."
  ...
  (lambda ()
    (interactive)
    (scroll-on-jump (call-interactively ,fn))))
...
without changing behavior anywhere else."
  ...
  (lambda ()
    (interactive)
    (scroll-on-jump-with-scroll (call-interactively ,fn))))
