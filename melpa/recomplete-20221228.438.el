...
;; Package-Commit: 0c7e988402af94fa8f8a2b0fec466015ef424ecb
;; Version: 0.2
      ...
      (save-excursion
        (save-match-data
          ...
          (let ((word-init (dabbrev--abbrev-at-point)))
            ...
            ;; Exclude this word from the list of options (if it exists at all).
            (setq result-choices (recomplete--rotate-list-by-elt-and-remove result-choices word-init)))
