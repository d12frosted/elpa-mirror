...
;; Package-Version: 20221227.1956
;; Package-Commit: 76d4480c07e4b04c3ebd9ded30d6d7acfebb9116
            ...
            (concat
             ...
             (regexp-quote
              (pcase backend
                ...
                (_ (format "%s:%d:" (file-relative-name buffer-file-name base-path) line-number)))))))
