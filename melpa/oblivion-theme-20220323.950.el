...
;; Package-Version: 20220323.950
;; Package-Commit: cfb92b89afd349589a3d47da2dad303fed0b7f83
;; Version: 0.1
...
(let
  ...
  (custom-theme-set-faces 'oblivion
    ...
    `(escape-glyph ((t (:foreground ,ob-scarletred2)))) ;; Not matching GEdit, just nice color.
    ...
    `(highlight-numbers-number ((t (:foreground ,ob-orange3))))
