...
;; Keywords: faces
;; Package-Version: 20221026.2317
;; Package-Commit: e9d91d91627f67121a2650b407e0d2ebdcb1a111
  ...
  (let ((colorful t)
    ...
    (let-alist color-alist
      (custom-theme-set-faces
       ...
       `(lazy-highlight ((,colorful (:distant-foreground ,.white :background ,.grayhighlight))))
