...
═════════════════
  ...
  When `:categoryp t' is used, ellama derives stable MCP tool identity
  as `<category>/<tool-name>' (for example `mcp-ddg/search').
  Irreversible policy, audit, and overrides are keyed by this identity.
