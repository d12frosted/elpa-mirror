...
────────────────
  ...
  narrowed) or region, and simultaneously have other occurrences edited
  in the same way, with visual feedback as you type.

  Normal scenario of Iedit mode is like:

  • Highlight certain contents - by press C-; (The default key binding)
    All occurrences of a symbol, string or a region in the buffer may be
    highlighted corresponding to current mark, point and prefix
