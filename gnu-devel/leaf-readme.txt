...
6.5 :preface, :init, :config keywords
─────────────────────────────────────
...
6.10 :bind-keymap, :bind-keymap* keywords
─────────────────────────────────────────
...
────────────────────────────────────────────
  ...
  *Unlike use-package*, you must specify a dot pair.
  ...
  The value set to `custom-face' should also be quoted to emphasize
  uniformity as `leaf'.
