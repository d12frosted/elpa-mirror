...
══════════════
  ...
  You can also install it with [straight.el] to have the latest updates
  easily.
  ...
  You can also clone the repository or download a specific version, and
  include the content it in `load-path'.
...
4.2 Use as a tree sitter mode for ESS
─────────────────────────────────────
...
4.4 Preparing the grammar from R package
────────────────────────────────────────
...
5 Original code and R for Emacs
═══════════════════════════════
