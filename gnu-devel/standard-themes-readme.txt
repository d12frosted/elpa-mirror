...
This manual, written by Protesilaos, describes the Emacs package called
`standard-themes', and provides every other piece of information
pertinent to it.
...
══════════════════
  ...
  Contributions to code
        Clemens Radermacher, Elías Gabriel Pérez, Trevor Arjeski.
