...
;; Package-Version: 20221227.1314
;; Package-Commit: 62939fe779b570a89033868177ffa8ce9cee986f
;; Version: 0.1
                ...
                (let
                    ((size-test
                      (condition-case err
                        ...
                        (error
                         (message "Unable to convert %S to a number: %s" size-old (error-message-string err))
                         nil))))
                  (when size-test
