...
;; Package-Version: 20221227.2250
;; Package-Commit: d3c9544c8e5afecb11a1e6a49fbda8b8af61fd75
;; Version: 0.1
    ...
    (directory-files-recursively root rst-file-match-regex
                                 ...
                                 (lambda (dir)
                                   (not
                                    (string-equal
                                     "."
                                     (substring (file-name-nondirectory dir)
                                                0 1)))))))
  ...
  (let* ((rst-filepath-no-ext
         ...
         (rst-files-test
          (directory-files rst-dir-part
                           t (concat "^" (regexp-quote rst-file-part))))
         (rst-filepath-found
          (catch 'result
            (let
            ...
            (let ((rst-role-id (match-string-no-properties 1 symbol))
              ...
              (cond
               ((string-equal rst-role-id "ref")
                (setq matches
                      (xref-rst--lookup-ref current-project-root rst-role-data)))

               ((string-equal rst-role-id "term")
                (setq matches
                      (xref-rst--lookup-term current-project-root rst-role-data)))
