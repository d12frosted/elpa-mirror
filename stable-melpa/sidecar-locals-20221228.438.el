...
;; Package-Commit: e6bdb261edc61ab87de8d0b81f3baea40b7256cd
        ...
        (delete
         ...
         (mapcar
          (lambda (dir-base)
            (cond
             ((or no-test
                  (sidecar-locals--trusted-p-with-warning
                   dir-base
                   path-trust))
  ...
  (sidecar-locals--apply
   ...
   (lambda (filepath)
     ...
     (condition-case-unless-debug err
       ...
       (error
        (message "sidecar-locals: error %s in %S"
