;;; tok-theme.el --- Comfy light monochromatic theme -*- lexical-binding: t; -*-

;; Author: Topi Kettunen <topi@topikettunen.com>
;; URL: https://github.com/topikettunen/tok-theme
;; Package-Version: 20221208.1538
;; Package-Commit: 691ddd831795c2cfa2be9a541e6b04eb66d88d34
;; Version: 0.1
...
;; Tok is a comfy light monochromatic theme.

;;; Code:

(deftheme tok
  "Comfy light monochromatic theme")

(let ((class '((class color) (min-colors 89)))
      (sun-1 "#ffd22a") (sun-2 "#ffe995") (sun-3 "#fff4cc"))
  
  (custom-theme-set-faces
   'tok
   ;; Basic faces
   `(default ((,class (:background "white" :foreground "black"))))
   `(highlight ((,class (:background ,sun-3))))
   ...
   ;; Mode-line
   `(mode-line ((,class (:foreground "black" :background ,sun-1 :box (:line-width -1 :style released-button)))))
   (when (>= emacs-major-version 29)
     `(mode-line-active ((,class (:inherit mode-line)))))
   `(mode-line-inactive ((,class (:weight light :foreground "black" :background ,sun-2))))
