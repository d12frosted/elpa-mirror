...
;; Package-Version: 20210922.113
;; Package-Commit: c0401226941f78e5e4c798afca2b75f69ffa0dd1
;; Version: 0.1
...
(defun hl-block--time-ensure (state)
  "Add the global idle timer is enabled if STATE is non-nil, otherwise disable."
  (cond
    (state
...
(defun hl-block--time-reset ()
  ...
  (hl-block--time-ensure (bound-and-true-p hl-block-mode)))
