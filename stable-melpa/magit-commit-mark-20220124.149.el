...
;; Package-Version: 20220124.149
;; Package-Commit: 126c8bc005c3c51784d744836c20c742b05b7112
;; Version: 0.1.0
...
(defcustom magit-commit-mark-sha1-length 11
...
Needed so we can be sure to view the required number of SHA1 chars."
  (pcase-let ((`(,args ,files) (funcall fn-orig mode)))
    (list (cons (format "--abbrev=%d" magit-commit-mark-sha1-length) args) files)))
