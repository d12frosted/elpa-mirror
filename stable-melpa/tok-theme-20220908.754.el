...
;; Package-Version: 20220908.754
;; Package-Commit: fb12b6f68a41f320dd51a151ed66939c314d3328
;; Version: 0.1
...
(let ((class '((class color) (min-colors 89))))
  (custom-theme-set-faces
   'tok
   `(default ((,class (:weight bold :foreground "gray90" :background "gray5"))))
   ...
   `(highlight ((,class (:background "gray15"))))
   ...
   `(line-number ((,class (:foreground "gray30"))))
   `(line-number-current-line ((,class (:foreground "yellow"))))
   ...
   `(mode-line ((,class (:foreground "gray80" :background "gray20" :box (:line-width -1 :style released-button)))))
   `(mode-line-inactive ((,class (:foreground "grey70" :background "grey35"))))
   ...
   `(font-lock-comment-face ((,class (:foreground "LightGoldenrod1"))))
   ...
   `(tab-bar-tab-group-current ((,class (:weight bold :inherit tab-bar-tab))))
   ...
   `(org-column ((,class (:weight normal :slant normal :background "grey30"))))
   ...
   `(gnus-summary-normal-undownloaded ((,class (:weight normal ,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "LightGray"))))
   ...
   `(mc/cursor-bar-face ((,class (:height 1 :background "white"))))
   `(mc/region-face ((,class (:inherit region))))
   `(magit-section-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :background "grey20"))))
   `(magit-section-heading ((,class (:weight bold ,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "LightGoldenrod2"))))
   `(magit-section-secondary-heading ((,class (:weight bold ,@(and (>= emacs-major-version 27) '(:extend t))))))
   `(magit-section-heading-selection ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "LightSalmon3"))))
   ...
   `(transient-separator ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :background "grey30"))))
   ...
   `(smerge-upper ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :background "#553333"))))
   `(smerge-lower ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :background "#335533"))))
   `(smerge-base ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :background "#888833"))))
   `(smerge-markers ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :background "grey30"))))
   ...
   `(magit-diff-file-heading-selection ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "LightSalmon3" :inherit magit-diff-file-heading-highlight))))
   `(magit-diff-hunk-heading ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "grey95" :background "grey25"))))
   `(magit-diff-hunk-heading-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "grey95" :background "grey35"))))
   `(magit-diff-hunk-heading-selection ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "LightSalmon3" :inherit magit-diff-hunk-heading-highlight))))
   ...
   `(magit-diff-lines-heading ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "grey80" :background "salmon4" :inherit magit-diff-hunk-heading-highlight))))
   ...
   `(magit-diff-added ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "#ddffdd" :background "#335533"))))
   `(magit-diff-removed ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "#ffdddd" :background "#553333"))))
   `(magit-diff-our ((,class (:inherit magit-diff-removed))))
   `(magit-diff-base ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "#ffffcc" :background "#555522"))))
   `(magit-diff-their ((,class (:inherit magit-diff-added))))
   `(magit-diff-context ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "grey70"))))
   `(magit-diff-added-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "#cceecc" :background "#336633"))))
   `(magit-diff-removed-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "#eecccc" :background "#663333"))))
   `(magit-diff-our-highlight ((,class (:inherit magit-diff-removed-highlight))))
   `(magit-diff-base-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "#eeeebb" :background "#666622"))))
   `(magit-diff-their-highlight ((,class (:inherit magit-diff-added-highlight))))
   `(magit-diff-context-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "grey70" :background "grey20"))))
   ...
   `(magit-blame-highlight ((,class (,@(and (>= emacs-major-version 27) '(:extend t)) :foreground "white" :background "grey25"))))
   ...
   `(c-nonbreakable-space-face ((,class (:foreground "Black" :background "White" :inherit error))))
