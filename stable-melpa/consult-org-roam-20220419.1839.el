...
;; Version: 0.1
;; Package-Version: 20220419.1839
;; Package-Commit: fd535800a615af4d2af0577e8351cb16561f0e32
  ...
  (let* ((nodes (org-roam-node-read--completions filter-fn sort-fn))
         ...
         (node
          (consult--read
           ...
           :lookup (lambda (selected candidates input _narrow) (alist-get selected candidates input #'equal)))))
