...
;; Package-Version: 20221228.340
;; Package-Commit: a1ae343d2a1123a2028f74d09309e5206a59fd39
;; Version: 0.1.0
  ...
  (let* ((repo-dir (magit-commit-mark--get-repo-dir))
    ...
    (save-excursion
      ...
      (while (and
              ...
              (not
               (setq found (magit-commit-mark--step-to-bit-test-at-point-strict repo-hash state flag))))
